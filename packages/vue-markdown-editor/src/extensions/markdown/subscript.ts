...
export const serializeSubscript: ConstructorParameters<typeof MarkdownSerializer>[1][string] = {close: (state) => { state.escapeWhitespace = false; return '~'; }, expelEnclosingWhitespace: true, mixable: false, open: (state) => { state.escapeWhitespace = true; return '~'; }};
