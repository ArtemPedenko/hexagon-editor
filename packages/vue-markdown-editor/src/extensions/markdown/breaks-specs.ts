...
export const serializeHardBreak: ConstructorParameters<typeof MarkdownSerializer>[0][string] = (
	state,
	node,
	parent,
	index,
...
export const serializeSoftBreak: ConstructorParameters<typeof MarkdownSerializer>[0][string] = (
	state,
	node,
	parent,
	index,
