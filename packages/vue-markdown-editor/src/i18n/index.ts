...
const en = {
    ...
    link: 'Link', linkNewWindow: 'Open in a new window', linkRemove: 'Remove', linkText: 'Link text', linkTextHelp: 'Text displayed as a link.', linkUrl: 'Link address',
...
const ru: Record<keyof typeof en, string> = {
    ...
    link: 'Ссылка', linkNewWindow: 'Открывать в новом окне', linkRemove: 'Удалить', linkText: 'Текст ссылки', linkTextHelp: 'Текст, который отображается как ссылка.', linkUrl: 'Адрес ссылки',
