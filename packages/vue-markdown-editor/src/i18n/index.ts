...
const en = {
    ...
    imageFit: 'Image display', imageHeight: 'Height', imageName: 'Image name', imageSizes: 'Size, px', imageTitle: 'Image title', imageUpload: 'Upload image', imageUploading: 'Uploading…', imageUploadError: 'Could not upload the image.', imageUrl: 'Image link',
...
const ru: Record<keyof typeof en, string> = {
    ...
    imageFit: 'Отображение изображения', imageHeight: 'Высота', imageName: 'Подпись к рисунку', imageSizes: 'Размер в пикселях', imageTitle: 'Заголовок изображения', imageUpload: 'Загрузить изображение', imageUploading: 'Загрузка…', imageUploadError: 'Не удалось загрузить изображение.', imageUrl: 'Ссылка картинки',
