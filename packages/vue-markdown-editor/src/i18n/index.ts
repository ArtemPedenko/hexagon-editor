...
const en = {
    ...
    link: 'Link', linkNewWindow: 'Open in a new window', linkRemove: 'Remove', linkText: 'Link text', linkTextHelp: 'Text displayed as a link.', linkTitle: 'Link title', linkUrl: 'Link address',
...
const ru: Record<keyof typeof en, string> = {
    ...
    link: 'Ссылка', linkNewWindow: 'Открывать в новом окне', linkRemove: 'Удалить', linkText: 'Текст ссылки', linkTextHelp: 'Текст, который отображается как ссылка.', linkTitle: 'Заголовок ссылки', linkUrl: 'Адрес ссылки',
