...
type PrioritizedFactory<Output> = {
  factory: (deps: ExtensionDeps) => Output;
...
export class ExtensionBuilder {
  ...
  addPlugin(factory: (deps: ExtensionDeps) => Plugin | Plugin[], priority = ExtensionPriority.Medium): this {
