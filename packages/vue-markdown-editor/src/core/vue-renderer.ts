...
export function createVueNodeView(component: Component, options: VueNodeViewOptions = {}): NodeViewConstructor {
...
export function createVueContextPanelPlugin(component: Component, options: VueContextPanelOptions = {}): Plugin {
  return new Plugin({
    view: (editorView) => {
