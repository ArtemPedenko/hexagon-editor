...
import {addTableColumn, addTableRow, deleteTable, deleteTableColumn, deleteTableRow, setTableColumnAlignment, TableCellAlign, TableNode} from '../extensions/markdown/table';
