  ...
  <main class="editor-view playground">
    <header class="playground__header">
      ...
      <p class="playground__status">
        {{ editorMode }} ·
        {{ example === 'advanced' ? 'расширенные Markdown-функции' : 'свой toolbar и API-загрузка' }} · {{ VERSION }}
      </p>
      <div
        class="playground__controls"
        aria-label="Настройки playground"
      >
        <label>
          Пример
          <select
            v-model="example"
            aria-label="Пример редактора"
          >
